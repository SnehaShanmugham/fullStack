...
//                                     <br></br>
//                                     <br></br>
//                                     <p><Link className='reg' to='/boat/UserLogin'>Already have an account? Login</Link></p>
//                                 </center>
//                             </div>
//                         </form>
//                     </div>
...
import { setName,setEmail,setMobile } from '../../redux/UserSlice';
...
const Registration = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Dispatch name, email, and mobileNumber to Redux
