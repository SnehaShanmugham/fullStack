      ...
      <CDBSidebar textColor="#fff" backgroundColor="black">
        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            ...
            <NavLink exact to="/boat/viewboat" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="table">View Boats</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/boat/userprofile" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="user">Profile page</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/boat/Mybooking" acti veClassName="activeClicked">
